...
<body>
  ...
  <ul id="slide-out" class="side-nav fixed z-depth-2">
    ...
    <li id="dash_dashboard"><a class="waves-effect" href="admin.html"><b>Панель управления</b></a></li>
  ...
  <header>
    ...
    <nav>
      <div class="nav-wrapper indigo darken-2">
        ...
        <a class="breadcrumb" href="#!">Страницы</a>
  ...
  <main>
    <div class="row">
        <div class="col s3">
          <div class="card hoverable">
            ...
            <div class="card-content">
              ...
              Вы можете изменить данные на странице в данной вкладке.
            </div>
          </div>
        </div>
        <div class="col s3">
        ...
        <div class="col s3">
            ...
            <div class="card-image">
                <img src="/img/s1.jpg">
                <span class="card-title">Цены</span>
            </div>
            <div class="card-content">
                <a class="btn-floating halfway-fab waves-effect waves-light red"><i class="material-icons">play_arrow</i></a>
                Вы можете изменить данные на странице в данной вкладке.
  ...
  <footer class="indigo page-footer">
    <div class="container">
      <div class="row">
        <div class="col s12">
          <h5 class="white-text">NFitness</h5>
        </div>
      </div>
    </div>
